...
class GlobalSystemData(proto.Message):
    ...
    highPvpGuarantee = proto.Field(proto.UINT32, number=270)
    highPVPPointsRange = proto.RepeatedField(proto.INT32, number=271)
    highPVPCoolDown = proto.Field(proto.UINT32, number=272)
    highPVPTicket = proto.Field(proto.UINT32, number=273)
    highPVPRankingListNum = proto.Field(proto.UINT32, number=274)
    counter418Interval = proto.Field(proto.INT32, number=275)
    bpCooperateTask = proto.Field(proto.BOOL, number=276)
    commandBackgroundTouchCd = proto.Field(proto.UINT32, number=277)
    chatOpen = proto.Field(proto.BOOL, number=278)
    gachaSpecialSrCheckList = proto.RepeatedField(proto.UINT32, number=279)
    gachaSpecialSrReplaceCount = proto.Field(proto.UINT32, number=280)
    gachaSpecialSrTypeId = proto.RepeatedField(proto.UINT32, number=281)
    bpEntryAnimationResource = proto.Field(proto.STRING, number=282)
    bpMaxLevel = proto.Field(proto.UINT32, number=283)
    bpExpItem = proto.Field(proto.UINT32, number=284)
    bpUpgradeExp = proto.Field(proto.UINT32, number=285)
    bpExtraExp = proto.Field(proto.UINT32, number=286)
    storeLimitPackShowTime = proto.Field(proto.UINT32, number=287)
    gachaExtraDropWeaponR = proto.MapField(proto.UINT32, proto.UINT32, number=288)
    gachaExtraDropGunR = proto.MapField(proto.UINT32, proto.UINT32, number=289)
    gachaExtraDropWeaponSr = proto.MapField(proto.UINT32, proto.UINT32, number=290)
    gachaExtraDropGunSr = proto.MapField(proto.UINT32, proto.UINT32, number=291)
    gachaExtraDropWeaponSsr = proto.MapField(proto.UINT32, proto.UINT32, number=292)
    gachaExtraDropGunSsr = proto.MapField(proto.UINT32, proto.UINT32, number=293)
    modDecomposeUpCost = proto.MapField(proto.UINT32, proto.UINT32, number=294)
    modDecomposeUpTimes = proto.MapField(proto.UINT32, proto.UINT32, number=295)
    modDecomposeUpLevel = proto.MapField(proto.UINT32, proto.UINT32, number=296)
    modCalibrationUpCost = proto.MapField(proto.UINT32, proto.UINT32, number=297)
    themeactivityOpen = proto.Field(proto.BOOL, number=298)
    modDecomposeUpCoinCost = proto.MapField(proto.UINT32, proto.UINT32, number=299)
    modCalibrationUpCoinCost = proto.MapField(proto.UINT32, proto.UINT32, number=300)
    modDecomposeUpSwitch = proto.Field(proto.BOOL, number=301)
    modCalibrationUpSwitch = proto.Field(proto.BOOL, number=302)
    modCalibrationPropertyNumSwitch = proto.Field(proto.BOOL, number=303)
    modCalibrationPropertyNum = proto.Field(proto.UINT32, number=304)
    activityTransportPptId = proto.Field(proto.INT32, number=305)
    repeatedlyWeaponSkin = proto.Field(proto.STRING, number=306)
    repeatedlyModSkin = proto.Field(proto.STRING, number=307)
    weaponSkinOpen = proto.Field(proto.BOOL, number=308)
    itemGetBattleSettlementNoshow = proto.RepeatedField(proto.UINT32, number=309)
...
class GunData(proto.Message):
    ...
    suppressGroup = proto.RepeatedField(proto.INT32, number=63)
    ...
    feature = proto.Field(proto.UINT32, number=71)
...
class GunPresetData(proto.Message):
    ...
    combatPowerReplace = proto.Field(proto.INT32, number=57)
    feature = proto.Field(proto.UINT32, number=58)
...
class GunWeaponData(proto.Message):
    ...
    weaponSkill = proto.RepeatedField(proto.UINT32, number=36)
...
class MonopolyDifficultyData(proto.Message):
    ...
    tokenIcon = proto.Field(proto.STRING, number=24)
    roundOccupyPoint = proto.Field(proto.UINT32, number=25)
    sweepUnlock = proto.RepeatedField(proto.UINT32, number=26)
    sweepCost = proto.MapField(proto.UINT32, proto.UINT32, number=27)
    sweepReward = proto.MapField(proto.UINT32, proto.UINT32, number=28)
    maxRewardPoint = proto.Field(proto.UINT32, number=29)
    sweepTimes = proto.Field(proto.UINT32, number=30)
