...
class ActivityListData(proto.Message):
    ...
    unLockID = proto.Field(proto.UINT32, number=13)
    args = proto.RepeatedField(proto.UINT32, number=14)
...
class AudioVoiceConfigData(proto.Message):
    ...
    sysBreakId = proto.RepeatedField(proto.UINT32, number=19)
...
class BarrackInteractData(proto.Message):
    ...
    weaponId = proto.RepeatedField(proto.UINT32, number=17)
...
class BattleBuffData(proto.Message):
    ...
    aiIgnore = proto.Field(proto.BOOL, number=5)
    buffGroupId = proto.Field(proto.INT32, number=6)
    level = proto.Field(proto.INT32, number=7)
    buffType = proto.Field(proto.UINT64, number=8)
    buffMold = proto.Field(proto.UINT32, number=9)
    buffEffect = proto.Field(proto.STRING, number=10)
    effectPlayTime = proto.RepeatedField(proto.INT32, number=11)
    shaderType = proto.Field(proto.UINT32, number=12)
    cameraPlayTime = proto.RepeatedField(proto.INT32, number=13)
    cameraTime = proto.Field(proto.STRING, number=14)
    unique = proto.Field(proto.UINT32, number=15)
    maxTier = proto.Field(proto.UINT32, number=16)
    overlying = proto.Field(proto.UINT32, number=17)
    lifetimeRound = proto.Field(proto.INT32, number=18)
    lifetimeDisplaynum = proto.Field(proto.INT32, number=19)
    lifetimeCondition = proto.Field(proto.STRING, number=20)
    lifetimeTrigger = proto.Field(proto.STRING, number=21)
    lifetimeTriggerPriority = proto.Field(proto.INT32, number=22)
    lifetimeAddition = proto.Field(proto.UINT32, number=23)
    ongoingEffect = proto.Field(proto.STRING, number=24)
    buffCondition = proto.Field(proto.STRING, number=25)
    buffTrigger = proto.Field(proto.STRING, number=26)
    resultTriggerPriority = proto.Field(proto.INT32, number=27)
    targetTrigger = proto.Field(proto.UINT32, number=28)
    triggerSkill = proto.RepeatedField(proto.INT32, number=29)
    buffTriggerMaker = proto.Field(proto.INT32, number=30)
    triggerRate = proto.Field(proto.INT32, number=31)
    notifyCount = proto.Field(proto.INT32, number=32)
    result = proto.Field(proto.STRING, number=33)
    targetSelect = proto.Field(proto.UINT32, number=34)
    conditionSeek = proto.Field(proto.STRING, number=35)
    targetSeek = proto.Field(proto.STRING, number=36)
    shape = proto.Field(proto.UINT32, number=37)
    shapeParam = proto.Field(proto.STRING, number=38)
    shapeCrossTerrain = proto.Field(proto.UINT32, number=39)
    condition = proto.Field(proto.STRING, number=40)
    effectType = proto.Field(proto.INT32, number=41)
    deadClear = proto.Field(proto.INT32, number=42)
    aiControl = proto.Field(proto.UINT32, number=43)
    buffFix = proto.Field(proto.INT32, number=44)
    existSuppressed = proto.Field(proto.UINT32, number=45)
    endstateFlag = proto.Field(proto.INT32, number=46)
    buffShareLimitGroup = proto.Field(proto.UINT32, number=47)
    beCommand = proto.Field(proto.BOOL, number=48)
    buffSymbiosis = proto.RepeatedField(proto.INT32, number=49)
    releasegirdMonitor = proto.Field(proto.UINT32, number=50)
...
class BattleMirageData(proto.Message):
    ...
    suppressGroup = proto.Field(proto.STRING, number=15)
...
class BattleSkillData(proto.Message):
    ...
    replaceDisplayId = proto.Field(proto.STRING, number=39)
    weaponTag = proto.Field(proto.INT32, number=40)
...
class BattleSummonedData(proto.Message):
    ...
    suppressGroup = proto.Field(proto.STRING, number=46)
...
class CalculateData(proto.Message):
    ...
    potentialParameter = proto.Field(proto.STRING, number=4)
    distenceParameter = proto.Field(proto.STRING, number=5)
    buffParameter = proto.Field(proto.STRING, number=6)
    suppressParameter = proto.Field(proto.STRING, number=7)
    beSuppressParameter = proto.Field(proto.STRING, number=8)
    moldParameter = proto.Field(proto.STRING, number=9)
...
class ClothesData(proto.Message):
    ...
    ultraskillAssets = proto.Field(proto.STRING, number=24)
    dormanimAssets = proto.Field(proto.STRING, number=25)
...
class DarkTutorialGroupData(proto.Message):
    ...
    finishGroup = proto.RepeatedField(proto.UINT32, number=6)
    isPause = proto.Field(proto.BOOL, number=7)
    isWasdBanned = proto.Field(proto.BOOL, number=8)
...
class DarkzoneEscortConfigData(proto.Message):
    ...
    startRequire = proto.RepeatedField(proto.UINT32, number=6)
    moveRespond = proto.Field(proto.INT32, number=7)
    lostTime = proto.Field(proto.INT32, number=8)
    lostResult = proto.Field(proto.INT32, number=9)
    moveControl = proto.RepeatedField(proto.UINT32, number=10)
    maxTemp = proto.Field(proto.UINT32, number=11)
    birthTemp = proto.Field(proto.INT32, number=12)
    riseTemp = proto.Field(proto.INT32, number=13)
    declineTemp = proto.Field(proto.INT32, number=14)
    bag = proto.Field(proto.BOOL, number=15)
    bagNum = proto.Field(proto.INT32, number=16)
    ...
    retreatChance = proto.Field(proto.UINT32, number=20)
    retreatBagNum = proto.Field(proto.UINT32, number=21)
    retreatHp = proto.Field(proto.UINT32, number=22)
    retreatState = proto.Field(proto.UINT32, number=23)
    retreatBuffLevel = proto.RepeatedField(proto.INT32, number=24)
    retreatBuff = proto.RepeatedField(proto.INT32, number=25)
...
class DarkzoneMapV2Data(proto.Message):
    ...
    difficultParam = proto.Field(proto.UINT32, number=18)
    noticeGroupId = proto.Field(proto.UINT32, number=19)
    enterDarkBgm = proto.Field(proto.UINT32, number=20)
    leftTimeBgm = proto.Field(proto.UINT32, number=21)
    cartpointStart = proto.Field(proto.UINT32, number=22)
    cartpointId = proto.Field(proto.UINT32, number=23)
...
class DormFormationData(proto.Message):
    ...
    unusedModle = proto.RepeatedField(proto.UINT32, number=16)
    modle01 = proto.Field(proto.STRING, number=17)
    modle02 = proto.Field(proto.STRING, number=18)
    modle03 = proto.Field(proto.STRING, number=19)
...
class DzBuffData(proto.Message):
    ...
    buffShowColor = proto.Field(LanguageStringData, number=5)
    descriptionBattle = proto.Field(LanguageStringData, number=6)
    icon = proto.Field(proto.STRING, number=7)
    effectTime = proto.Field(proto.UINT32, number=8)
    effectId = proto.Field(proto.UINT32, number=9)
    sysName = proto.Field(proto.STRING, number=10)
    buffGroup = proto.Field(proto.UINT32, number=11)
    buffRank = proto.Field(proto.UINT32, number=12)
    buffType = proto.Field(proto.UINT32, number=13)
    duration = proto.Field(proto.INT32, number=14)
    flag = proto.Field(proto.UINT32, number=15)
    interval = proto.Field(proto.INT32, number=16)
    buffEffect = proto.RepeatedField(proto.UINT32, number=17)
    overlying = proto.Field(proto.UINT32, number=18)
    maxTier = proto.Field(proto.UINT32, number=19)
    enableCameraMould = proto.Field(proto.UINT32, number=20)
    isBannerShow = proto.Field(proto.UINT32, number=21)
...
class DzCartpointDepotData(proto.Message):
    ...
    ifArchive = proto.Field(proto.BOOL, number=4)
    position = proto.RepeatedField(proto.INT32, number=5)
    forwardPoint = proto.Field(proto.STRING, number=6)
    backwardPoint = proto.Field(proto.STRING, number=7)
    approachList = proto.Field(proto.STRING, number=8)
    backapproachList = proto.Field(proto.STRING, number=9)
...
class DzIobjMainData(proto.Message):
    ...
    severInteractCollision = proto.Field(proto.STRING, number=12)
    monsterInteractCollision = proto.Field(proto.STRING, number=13)
    backCollision = proto.Field(proto.STRING, number=14)
    useLimit = proto.Field(proto.INT32, number=15)
    cd = proto.RepeatedField(proto.INT32, number=16)
    cdSequence = proto.MapField(proto.UINT32, proto.UINT32, number=17)
    costType = proto.Field(proto.INT32, number=18)
    costId = proto.RepeatedField(proto.INT32, number=19)
    costNum = proto.RepeatedField(proto.INT32, number=20)
    activeShape = proto.Field(proto.BOOL, number=21)
    shapeIds = proto.RepeatedField(proto.UINT32, number=22)
    isShowInteractToken = proto.Field(proto.UINT32, number=23)
    interactTokenState = proto.MapField(proto.UINT32, proto.UINT32, number=24)
    param = proto.Field(proto.STRING, number=25)
    isInvisiableInGrass = proto.Field(proto.UINT32, number=26)
    showInSlg = proto.Field(proto.UINT32, number=27)
    isShowOnMinimap = proto.Field(proto.UINT32, number=28)
    tokenByState = proto.MapField(proto.UINT32, proto.UINT32, number=29)
    frontCheck = proto.Field(proto.UINT32, number=30)
    tokenYShifting = proto.Field(proto.UINT32, number=31)
...
class DzMonsterDepotData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    type = proto.Field(proto.UINT32, number=2)
    ifloop = proto.Field(proto.UINT32, number=3)
    crossPathSrc = proto.Field(proto.STRING, number=4)
...
class EnemyData(proto.Message):
    ...
    suppressGroup = proto.Field(proto.STRING, number=51)
...
class EventSigninRewardData(proto.Message):
    ...
    rewards = proto.MapField(proto.UINT32, proto.UINT32, number=4)
...
class GachaData(proto.Message):
    ...
    gunRate = proto.Field(proto.STRING, number=18)
    rateDesGun = proto.Field(proto.STRING, number=19)
    rateDesWeapon = proto.Field(proto.STRING, number=20)
    gachaStartScene = proto.Field(proto.STRING, number=21)
    gachaStartTimeline = proto.Field(proto.STRING, number=22)
    gunUpRate = proto.Field(proto.STRING, number=23)
    gunUpItem = proto.Field(proto.STRING, number=24)
    weaponUpRate = proto.Field(proto.STRING, number=25)
    weaponUpItem = proto.Field(proto.STRING, number=26)
    gunUpCharacter = proto.Field(proto.STRING, number=27)
    gunUpCharacterName = proto.Field(LanguageStringData, number=28)
    gunUpCharacterVideo = proto.Field(proto.STRING, number=29)
    gunUpCharacterStage = proto.Field(proto.STRING, number=30)
    gachaNoviceLimit = proto.Field(proto.UINT32, number=31)
...
class GlobalSystemData(proto.Message):
    ...
    weaponDefault = proto.Field(proto.STRING, number=40)
    weaponDecomposeLevel = proto.Field(proto.DOUBLE, number=41)
    weaponDecomposeClass = proto.Field(proto.DOUBLE, number=42)
    weaponCoinReturn = proto.Field(proto.DOUBLE, number=43)
    weaponCashReturn = proto.Field(proto.DOUBLE, number=44)
    weaponAdvanceExpcost = proto.Field(proto.UINT32, number=45)
    weaponAdvanceCost = proto.MapField(proto.UINT32, proto.UINT32, number=46)
    modPolarityExpItems = proto.MapField(proto.UINT32, proto.UINT32, number=47)
    modDecomposeLevel = proto.Field(proto.DOUBLE, number=48)
    modDecomposeStrengthen = proto.Field(proto.DOUBLE, number=49)
    touristpayHint = proto.Field(proto.UINT32, number=50)
    touristlogoutHint = proto.Field(proto.UINT32, number=51)
    touristinterval = proto.Field(proto.UINT32, number=52)
    touristactivetime = proto.Field(proto.UINT32, number=53)
    talentVersion = proto.Field(proto.UINT32, number=54)
    talentKeyDisposalLimit = proto.Field(proto.UINT32, number=55)
    storeexchangeDefaultTag = proto.Field(proto.UINT32, number=56)
    storeNpcTouchDailylimit = proto.Field(proto.UINT32, number=57)
    storeNpcTouchAffection = proto.Field(proto.UINT32, number=58)
    storeNpcIdle = proto.Field(proto.UINT32, number=59)
    storeNpcDelay = proto.Field(proto.UINT32, number=60)
    storeNpcBuyAffection = proto.Field(proto.UINT32, number=61)
    storeDailyrewardMailtemp = proto.Field(proto.UINT32, number=62)
    storeAffectionRecommendMultiple = proto.Field(proto.UINT32, number=63)
    storeAffectionMultiple = proto.Field(proto.UINT32, number=64)
    skillUnlockRank = proto.RepeatedField(proto.INT32, number=65)
    simweeklySettlementDuration = proto.Field(proto.UINT32, number=66)
    weeklyRefreshTimes = proto.Field(proto.UINT32, number=67)
    weeklyCycleArg = proto.RepeatedField(proto.DOUBLE, number=68)
    simweeklySettlementCycle = proto.Field(proto.STRING, number=69)
    simweeklySettlementClientReopen = proto.Field(proto.STRING, number=70)
    simweeklySettlementClientClose = proto.Field(proto.STRING, number=71)
    simweeklyServerSettlement = proto.Field(proto.STRING, number=72)
    simweeklyReopen = proto.Field(proto.STRING, number=73)
    simweeklyDuration = proto.Field(proto.UINT32, number=74)
    simweeklyCloseEntrance = proto.Field(proto.STRING, number=75)
    simweeklyCloseDay = proto.Field(proto.UINT32, number=76)
    settlementStaytime = proto.Field(proto.UINT32, number=77)
    setRatioVoice = proto.Field(proto.DOUBLE, number=78)
    setRatioBGM = proto.Field(proto.DOUBLE, number=79)
    setRatioAudio = proto.Field(proto.DOUBLE, number=80)
    setRatioAni = proto.Field(proto.DOUBLE, number=81)
    setInitialVolumeVoice = proto.Field(proto.UINT32, number=82)
    setInitialVolumeBGM = proto.Field(proto.UINT32, number=83)
    setInitialVolumeAudio = proto.Field(proto.UINT32, number=84)
    setInitialVolumeAni = proto.Field(proto.UINT32, number=85)
    serverOpenTime = proto.RepeatedField(proto.UINT32, number=86)
    reconnectionTimeSingle = proto.Field(proto.UINT32, number=87)
    reconnectionTimeLimit = proto.Field(proto.UINT32, number=88)
    reconnectTime2 = proto.Field(proto.UINT32, number=89)
    reconnectTime1 = proto.Field(proto.UINT32, number=90)
    raidOnetimeLimit = proto.Field(proto.UINT32, number=91)
    qualityStar = proto.RepeatedField(proto.UINT32, number=92)
    pvpSettlementCycle = proto.Field(proto.STRING, number=93)
    pvpSettlementClientReopen = proto.Field(proto.STRING, number=94)
    pvpSettlementClientClose = proto.Field(proto.STRING, number=95)
    pvpRevengelistMax = proto.Field(proto.UINT32, number=96)
    pvpRefreshTime = proto.Field(proto.UINT32, number=97)
    pvpRefreshMintime = proto.Field(proto.UINT32, number=98)
    pvpRefreshMaxtimes = proto.Field(proto.UINT32, number=99)
    pvpRefreshCost = proto.Field(proto.UINT32, number=100)
    pvpEloLevel = proto.Field(proto.UINT32, number=101)
    pvpEloK = proto.Field(proto.UINT32, number=102)
    pvpContinuityWeeknumber = proto.Field(proto.UINT32, number=103)
    pvpContinuityTimes = proto.Field(proto.UINT32, number=104)
    pvpContinuityReward = proto.MapField(proto.UINT32, proto.UINT32, number=105)
    pvpContinuityPoints = proto.RepeatedField(proto.UINT32, number=106)
    pvpChallengelistRenewTime = proto.Field(proto.UINT32, number=107)
    pvpChallengelistRenewCost = proto.Field(proto.UINT32, number=108)
    pvpAutoPoints = proto.RepeatedField(proto.UINT32, number=109)
    pvpActivityMax = proto.Field(proto.UINT32, number=110)
    newbietaskOpen = proto.Field(proto.BOOL, number=111)
    pvpOfflineKeepTime = proto.Field(proto.INT32, number=112)
    mythicRecover = proto.Field(proto.DOUBLE, number=113)
    mythicLevelArgs = proto.RepeatedField(proto.UINT32, number=114)
    mythicCharacterArgs = proto.RepeatedField(proto.UINT32, number=115)
    mythicBufflevelLimit = proto.Field(proto.UINT32, number=116)
    mythicAutofinish = proto.Field(proto.UINT32, number=117)
    memberDonationLimit = proto.Field(proto.UINT32, number=118)
    loungeMessageFavor = proto.RepeatedField(proto.UINT32, number=119)
    launcherItemType = proto.RepeatedField(proto.UINT32, number=120)
    kidstimetotallimitHint = proto.Field(proto.UINT32, number=121)
    kidstimelimitHint = proto.Field(proto.UINT32, number=122)
    kidspayHint3 = proto.Field(proto.UINT32, number=123)
    kidspayHint2 = proto.Field(proto.UINT32, number=124)
    kidspayHint1 = proto.Field(proto.UINT32, number=125)
    itemComposeMax = proto.Field(proto.UINT32, number=126)
    gunPerformanceIdleTriggeringtime = proto.Field(proto.UINT32, number=127)
    gunPerformanceIdleGlobalCD = proto.Field(proto.UINT32, number=128)
    gunMaxLv = proto.Field(proto.INT32, number=129)
    gunExceedlevel = proto.Field(proto.INT32, number=130)
    getwayStoryUpperlimit = proto.Field(proto.UINT32, number=131)
    gachaTimePhase3 = proto.Field(proto.UINT32, number=132)
    gachaStartRatePhase3 = proto.Field(proto.DOUBLE, number=133)
    gachaStartRatePhase2 = proto.Field(proto.DOUBLE, number=134)
    gachaSpeedPhase2 = proto.Field(proto.DOUBLE, number=135)
    gachaSpecielTimelineRate = proto.Field(proto.UINT32, number=136)
    gachaOverGetChangeMagnification5 = proto.Field(proto.DOUBLE, number=137)
    gachaOverGetChangeMagnification4 = proto.Field(proto.DOUBLE, number=138)
    gachaOverGetChangeMagnification3 = proto.Field(proto.DOUBLE, number=139)
    gachaOverGetChangeMagnification2 = proto.Field(proto.DOUBLE, number=140)
    gachaOverGetChangeMagnification1 = proto.Field(proto.DOUBLE, number=141)
    gachaOverGetChangeItem = proto.Field(proto.UINT32, number=142)
    gachaLimitTimes = proto.Field(proto.STRING, number=143)
    gachaLimitIsvisible = proto.Field(proto.BOOL, number=144)
    gachaFirsttimeJumpConfig = proto.RepeatedField(proto.UINT32, number=145)
    gachaFirsttimeCounter = proto.RepeatedField(proto.UINT32, number=146)
    gachaFirsttime = proto.Field(proto.UINT32, number=147)
    gachaCostTen = proto.Field(proto.UINT32, number=148)
    gachaCostOne = proto.Field(proto.UINT32, number=149)
    friendRefreshCd = proto.Field(proto.UINT32, number=150)
    friendRecommend = proto.Field(proto.UINT32, number=151)
    friendListCdtime = proto.Field(proto.UINT32, number=152)
    friendLimit = proto.Field(proto.UINT32, number=153)
    friendListUse = proto.Field(proto.UINT32, number=154)
    friendAssistRandomlimit = proto.Field(proto.UINT32, number=155)
    favorWarnValue = proto.Field(proto.INT32, number=156)
    favorWarnPremise = proto.Field(proto.INT32, number=157)
    favorWarn = proto.Field(proto.INT32, number=158)
    favorRoleId = proto.MapField(proto.UINT32, proto.UINT32, number=159)
    favorObtain1 = proto.Field(proto.INT32, number=160)
    favorExaminationValue = proto.Field(proto.INT32, number=161)
    favorExamination = proto.Field(proto.INT32, number=162)
    favorDeclineValue = proto.Field(proto.INT32, number=163)
    favorDeclineMaximum = proto.Field(proto.INT32, number=164)
    favorDeclineCoefficient = proto.Field(proto.INT32, number=165)
    battleFavor = proto.Field(proto.UINT32, number=166)
    dormStatemachineParameter = proto.RepeatedField(proto.UINT32, number=167)
    dormPlotSingletime = proto.Field(proto.UINT32, number=168)
    dormFavorPlot = proto.Field(proto.UINT32, number=169)
    difficultySweepsTimes = proto.Field(proto.UINT32, number=170)
    difficultyStageSweepsTimes = proto.Field(proto.UINT32, number=171)
    defaultUavArm = proto.Field(proto.UINT32, number=172)
    defaultAdjutant = proto.RepeatedField(proto.UINT32, number=173)
    darkzoneUnitGunDefault = proto.RepeatedField(proto.UINT32, number=174)
    darkzoneUnitCharacterCameraFov = proto.Field(proto.DOUBLE, number=175)
    darkzoneUnitCameraFov = proto.Field(proto.DOUBLE, number=176)
    darkzoneUnitCameraBone = proto.Field(proto.STRING, number=177)
    darkzoneSplitReward = proto.MapField(proto.UINT32, proto.UINT32, number=178)
    darkzoneSplitLimit = proto.Field(proto.UINT32, number=179)
    darkzoneQuestDailyLimit = proto.Field(proto.UINT32, number=180)
    darkzoneNoviceQuestGroup = proto.Field(proto.UINT32, number=181)
    darkzoneBeginnerQuestGroup = proto.RepeatedField(proto.UINT32, number=182)
    dailyQuestItem = proto.Field(proto.UINT32, number=183)
    dailyQuestDefaultRewardGroup = proto.Field(proto.UINT32, number=184)
    counterSimulationTypeConfig = proto.RepeatedField(proto.UINT32, number=185)
    commissionTimesArgs = proto.RepeatedField(proto.UINT32, number=186)
    commissionDurationArgs = proto.Field(proto.DOUBLE, number=187)
    commanderLevel = proto.Field(proto.INT32, number=188)
    commandBackgroundOutsideDefault = proto.Field(proto.UINT32, number=189)
    commandBackgroundInsideDefault = proto.Field(proto.UINT32, number=190)
    commandBackgroundDefault = proto.Field(proto.UINT32, number=191)
    commandBackAdjutantDefault = proto.RepeatedField(proto.UINT32, number=192)
    commandAdjutantDefault = proto.Field(proto.UINT32, number=193)
    checkinId = proto.Field(proto.UINT32, number=194)
    chatRefreshCd = proto.Field(proto.UINT32, number=195)
    chatMessageLimit = proto.Field(proto.UINT32, number=196)
    chatMessageCd = proto.Field(proto.UINT32, number=197)
    chatChannelRemoveCd = proto.Field(proto.UINT32, number=198)
    chatChannelLimit = proto.Field(proto.UINT32, number=199)
    characterNearCamera = proto.RepeatedField(proto.DOUBLE, number=200)
    characterUpgradeCost = proto.RepeatedField(proto.UINT32, number=201)
    blackListUpperLimit = proto.Field(proto.UINT32, number=202)
    battlepassTaskWeeklyToplimit = proto.Field(proto.UINT32, number=203)
    battlepassTaskWeeklyRefreshFrequency = proto.Field(proto.UINT32, number=204)
    battlepassTaskWeeklyRefreshConsume = proto.MapField(proto.UINT32, proto.UINT32, number=205)
    battlepassTaskShareToplimit2 = proto.Field(proto.UINT32, number=206)
    battlepassTaskShareToplimit1 = proto.Field(proto.UINT32, number=207)
    battlepassTaskShareTimelimit = proto.Field(proto.UINT32, number=208)
    battlepassTaskShareNumlimit = proto.Field(proto.UINT32, number=209)
    battlepassTaskShareItem = proto.MapField(proto.UINT32, proto.UINT32, number=210)
    battlepassTaskExtraToplimit = proto.Field(proto.UINT32, number=211)
    battlepassTaskExtraItem = proto.MapField(proto.UINT32, proto.UINT32, number=212)
    battlepassTaskDailyToplimit = proto.Field(proto.UINT32, number=213)
    battlepassTaskDailyRefreshFrequency = proto.Field(proto.UINT32, number=214)
    battlepassTaskDailyRefreshConsume = proto.MapField(proto.UINT32, proto.UINT32, number=215)
    battlepassShareTeamTimelimit = proto.Field(proto.UINT32, number=216)
    battlepassShareTaskTime = proto.Field(proto.UINT32, number=217)
    battlepassResourcesTask = proto.Field(proto.STRING, number=218)
    battlepassResourcesShop = proto.Field(proto.STRING, number=219)
    battlepassResourcesMain = proto.Field(proto.STRING, number=220)
    battlepassResourcesCollection = proto.Field(proto.STRING, number=221)
    battlepassBuyExperience = proto.Field(proto.UINT32, number=222)
    barracksBackgroundOutsideDefault = proto.Field(proto.UINT32, number=223)
    backpackJumpSwitch = proto.Field(proto.UINT32, number=224)
    backdropDefaultId = proto.MapField(proto.UINT32, proto.UINT32, number=225)
    backdropBehaveTime = proto.Field(proto.INT32, number=226)
    autoOfflineDelay = proto.Field(proto.UINT32, number=227)
    assistantRewardMin = proto.Field(proto.UINT32, number=228)
    assistantReward = proto.MapField(proto.UINT32, proto.UINT32, number=229)
    assistantListMin = proto.Field(proto.UINT32, number=230)
    assistantListMax = proto.Field(proto.UINT32, number=231)
    assistantCooldownStranger = proto.Field(proto.UINT32, number=232)
    assistantCooldownGuildmember = proto.Field(proto.UINT32, number=233)
    assistantCooldownFriend = proto.Field(proto.UINT32, number=234)
    assistantAvailableStagetype = proto.RepeatedField(proto.UINT32, number=235)
    assistantAmountStrange = proto.Field(proto.UINT32, number=236)
    assistantAmountGuildmember = proto.Field(proto.UINT32, number=237)
    assistantAmountFriend = proto.Field(proto.UINT32, number=238)
    assistDefaultGunid = proto.Field(proto.UINT32, number=239)
    adjutantStandbyTime = proto.Field(proto.UINT32, number=240)
    uavMaxLv = proto.Field(proto.UINT32, number=241)
    uavExceedlevel = proto.Field(proto.UINT32, number=242)
    equipmentPackageStoreid = proto.Field(proto.UINT32, number=243)
    equipSubPropertyToplimit = proto.Field(proto.UINT32, number=244)
    equipSubPropertyLevel = proto.Field(proto.UINT32, number=245)
    equipLvFoodItemList = proto.RepeatedField(proto.UINT32, number=246)
    equipExpReturn = proto.Field(proto.DOUBLE, number=247)
    equipCashReturn = proto.Field(proto.DOUBLE, number=248)
    equipAddOnceMax = proto.Field(proto.UINT32, number=249)
    guildiconbId = proto.Field(proto.INT32, number=250)
    guildiconaId = proto.Field(proto.INT32, number=251)
    guildannouncementLimit = proto.Field(proto.UINT32, number=252)
    guildTitleBgcolor = proto.Field(proto.STRING, number=253)
    guildMaxSubleader = proto.Field(proto.UINT32, number=254)
    guildMaxApplication = proto.RepeatedField(proto.UINT32, number=255)
    guildDonationLimit = proto.Field(proto.UINT32, number=256)
    guildCurrency = proto.RepeatedField(proto.UINT32, number=257)
    guildCreationPrice = proto.MapField(proto.UINT32, proto.UINT32, number=258)
    guildCreationLevel = proto.Field(proto.UINT32, number=259)
    guildAssistRandomlimit = proto.Field(proto.UINT32, number=260)
    goldGradeColor = proto.RepeatedField(proto.STRING, number=261)
    gachaCostTenNew = proto.Field(proto.INT32, number=262)
    itemGetCommonWindowNoshow = proto.RepeatedField(proto.UINT32, number=263)
    mainScreenAvgId = proto.Field(proto.INT32, number=264)
    barrackFirstAvgId = proto.Field(proto.INT32, number=265)
    rechargeRebateMailTime = proto.Field(proto.INT64, number=266)
    battlepassTaskDailyLimitTypeCount = proto.MapField(proto.UINT32, proto.UINT32, number=267)
    gachaSelfSelectedRoleId = proto.RepeatedField(proto.UINT32, number=268)
    gachaSelfSelectedProcess = proto.Field(proto.UINT32, number=269)
    counter418Interval = proto.Field(proto.INT32, number=270)
    bpCooperateTask = proto.Field(proto.BOOL, number=271)
    chatOpen = proto.Field(proto.BOOL, number=272)
    gachaSpecialSrCheckList = proto.RepeatedField(proto.UINT32, number=273)
    gachaSpecialSrReplaceCount = proto.Field(proto.UINT32, number=274)
    gachaSpecialSrTypeId = proto.RepeatedField(proto.UINT32, number=275)
    bpEntryAnimationResource = proto.Field(proto.STRING, number=276)
    bpMaxLevel = proto.Field(proto.UINT32, number=277)
    bpExpItem = proto.Field(proto.UINT32, number=278)
    bpUpgradeExp = proto.Field(proto.UINT32, number=279)
    bpExtraExp = proto.Field(proto.UINT32, number=280)
    storeLimitPackShowTime = proto.Field(proto.UINT32, number=281)
    gachaExtraDropWeaponR = proto.MapField(proto.UINT32, proto.UINT32, number=282)
    gachaExtraDropGunR = proto.MapField(proto.UINT32, proto.UINT32, number=283)
    gachaExtraDropWeaponSr = proto.MapField(proto.UINT32, proto.UINT32, number=284)
    gachaExtraDropGunSr = proto.MapField(proto.UINT32, proto.UINT32, number=285)
    gachaExtraDropWeaponSsr = proto.MapField(proto.UINT32, proto.UINT32, number=286)
    gachaExtraDropGunSsr = proto.MapField(proto.UINT32, proto.UINT32, number=287)
    themeactivityOpen = proto.Field(proto.BOOL, number=288)
...
class GunData(proto.Message):
    ...
    weaponDefault = proto.Field(proto.UINT32, number=27)
    moveCode = proto.Field(proto.UINT32, number=28)
    soldGet1 = proto.MapField(proto.UINT32, proto.UINT32, number=29)
    systemSwitch = proto.Field(proto.UINT32, number=30)
    useFakeAttack = proto.Field(proto.BOOL, number=31)
    camp = proto.Field(proto.UINT32, number=32)
    defaultGrade = proto.Field(proto.UINT32, number=33)
    unlockCost = proto.Field(proto.UINT32, number=34)
    grade = proto.Field(proto.UINT32, number=35)
    gunClass = proto.Field(proto.UINT32, number=36)
    barrackCameraSetting = proto.Field(proto.STRING, number=37)
    avatar = proto.Field(proto.UINT32, number=38)
    costumeId = proto.Field(proto.UINT32, number=39)
    costumeReplace = proto.RepeatedField(proto.UINT32, number=40)
    propertyId = proto.Field(proto.UINT32, number=41)
    barrackEffectId = proto.RepeatedField(proto.UINT32, number=42)
    weight = proto.Field(proto.UINT32, number=43)
    barrackAudioId = proto.Field(proto.UINT32, number=44)
    shieldType = proto.Field(proto.UINT32, number=45)
    maxGrade = proto.Field(proto.UINT32, number=46)
    shieldEffectId = proto.Field(proto.UINT32, number=47)
    baseSupply = proto.Field(proto.UINT32, number=48)
    supplyTypeBanList = proto.RepeatedField(proto.UINT32, number=49)
    extraSkill = proto.Field(proto.UINT32, number=50)
    shieldBrokenEffectId = proto.Field(proto.UINT32, number=51)
    attackType = proto.Field(proto.UINT32, number=52)
    gachaGetTimeline = proto.Field(proto.STRING, number=53)
    beSuppressedConfig = proto.RepeatedField(proto.INT32, number=54)
    shape = proto.Field(proto.UINT32, number=55)
    shapeParam = proto.Field(proto.STRING, number=56)
    shapeIcon = proto.Field(proto.STRING, number=57)
    shapeTerrain = proto.Field(proto.UINT32, number=58)
    idleType = proto.Field(proto.UINT32, number=59)
    displacement = proto.Field(proto.UINT32, number=60)
    isHide = proto.Field(proto.BOOL, number=61)
    weakTag = proto.Field(proto.STRING, number=62)
    suppressGroup = proto.Field(proto.STRING, number=63)
    unlockHint = proto.Field(proto.UINT32, number=64)
    unlockDorm = proto.RepeatedField(proto.UINT32, number=65)
    guardRadius = proto.Field(proto.INT32, number=66)
    guardRadiusShow = proto.Field(proto.INT32, number=67)
    gachaGetAudio = proto.Field(proto.UINT32, number=68)
    gachaGetVoice = proto.Field(proto.UINT32, number=69)
    weakWeaponTag = proto.Field(proto.INT32, number=70)
...
class GunPresetData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    sourceId = proto.Field(proto.UINT32, number=2)
    clothesId = proto.Field(proto.UINT32, number=3)
    modelCode = proto.Field(proto.UINT32, number=4)
    level = proto.Field(proto.UINT32, number=5)
    propertyPresetId = proto.Field(proto.UINT32, number=6)
    isChangeSkill = proto.Field(proto.BOOL, number=7)
    skillNormalAttack = proto.Field(proto.UINT32, number=8)
    skillActive = proto.Field(proto.UINT32, number=9)
    skillActive2 = proto.Field(proto.UINT32, number=10)
    skillTalent = proto.Field(proto.UINT32, number=11)
    skillSuper = proto.Field(proto.UINT32, number=12)
    skillActiveExtra = proto.RepeatedField(proto.UINT32, number=13)
    skillTalentExtra = proto.RepeatedField(proto.UINT32, number=14)
    extraSkill = proto.Field(proto.UINT32, number=15)
    grade = proto.Field(proto.UINT32, number=16)
    weaponDefault = proto.Field(proto.UINT32, number=17)
    baseSupply = proto.Field(proto.UINT32, number=18)
    weaponLevel = proto.Field(proto.UINT32, number=19)
    weaponGrade = proto.Field(proto.UINT32, number=20)
    weaponModList = proto.RepeatedField(proto.UINT32, number=21)
    weaponModLevelList = proto.RepeatedField(proto.UINT32, number=22)
    weaponModAffixList = proto.Field(proto.STRING, number=23)
    talentGroupPos = proto.Field(proto.UINT32, number=24)
    talentNodeLevelList = proto.Field(proto.STRING, number=25)
    name = proto.Field(LanguageStringData, number=26)
    walk = proto.Field(proto.UINT32, number=27)
    climb = proto.Field(proto.UINT32, number=28)
    fly = proto.Field(proto.UINT32, number=29)
    shin = proto.Field(proto.UINT32, number=30)
    moveCode = proto.Field(proto.UINT32, number=31)
    propertyId = proto.Field(proto.UINT32, number=32)
    aiList = proto.RepeatedField(proto.INT32, number=33)
    shieldForDeploy = proto.Field(proto.UINT32, number=34)
    tag = proto.Field(proto.STRING, number=35)
    attackType = proto.Field(proto.UINT32, number=36)
    element = proto.Field(proto.UINT32, number=37)
    shieldType = proto.Field(proto.UINT32, number=38)
    shieldEffectId = proto.Field(proto.UINT32, number=39)
    shieldBrokenEffectId = proto.Field(proto.UINT32, number=40)
    isClassTalentFullUpgraded = proto.Field(proto.BOOL, number=41)
    presetType = proto.Field(proto.UINT32, number=42)
    beSuppressedConfig = proto.RepeatedField(proto.INT32, number=43)
    idleType = proto.Field(proto.UINT32, number=44)
    skillGradeGroup = proto.RepeatedField(proto.UINT32, number=45)
    skillExtraGroup = proto.RepeatedField(proto.UINT32, number=46)
    weakTag = proto.Field(proto.STRING, number=47)
    guardRadius = proto.Field(proto.INT32, number=48)
    guardRadiusShow = proto.Field(proto.INT32, number=49)
    skillFaction = proto.Field(proto.UINT32, number=50)
    skillFaction2 = proto.Field(proto.UINT32, number=51)
    enablePrivateSkill = proto.Field(proto.UINT32, number=52)
    weaponModAlienationList = proto.RepeatedField(proto.UINT32, number=53)
    talentSkillList = proto.RepeatedField(proto.UINT32, number=54)
    jump = proto.Field(proto.UINT32, number=55)
    weakWeaponTag = proto.Field(proto.INT32, number=56)
...
class GunWeaponData(proto.Message):
    ...
    element = proto.Field(proto.UINT32, number=6)
    resCode = proto.Field(proto.STRING, number=7)
    resPath = proto.Field(proto.STRING, number=8)
    brand = proto.Field(proto.STRING, number=9)
    rank = proto.Field(proto.INT32, number=10)
    elemenSkill = proto.Field(proto.UINT32, number=11)
    skill = proto.Field(proto.UINT32, number=12)
    buffSkill = proto.Field(proto.UINT32, number=13)
    slot = proto.RepeatedField(proto.UINT32, number=14)
    expRate = proto.Field(proto.UINT32, number=15)
    weaponOfferExp = proto.Field(proto.UINT32, number=16)
    weaponNeedCash = proto.Field(proto.UINT32, number=17)
    defaultMaxlv = proto.Field(proto.UINT32, number=18)
    maxBreak = proto.Field(proto.UINT32, number=19)
    soldDrop = proto.RepeatedField(proto.UINT32, number=20)
    soldGet = proto.MapField(proto.UINT32, proto.UINT32, number=21)
    propertyId = proto.Field(proto.UINT32, number=22)
    unlockCost = proto.MapField(proto.UINT32, proto.UINT32, number=23)
    privateSkill = proto.Field(proto.UINT32, number=24)
    capacityMax = proto.Field(proto.UINT32, number=25)
    weaponPolarityId = proto.Field(proto.UINT32, number=26)
    polarityCostRandom = proto.MapField(proto.UINT32, proto.UINT32, number=27)
    polarityCostCustom = proto.MapField(proto.UINT32, proto.UINT32, number=28)
    advanceWeapon = proto.RepeatedField(proto.UINT32, number=29)
    characterId = proto.Field(proto.UINT32, number=30)
    modNum = proto.Field(proto.UINT32, number=31)
    modTypeGroup = proto.RepeatedField(proto.UINT32, number=32)
    isHide = proto.Field(proto.BOOL, number=33)
    audio = proto.Field(proto.UINT32, number=34)
    weaponTag = proto.Field(proto.INT32, number=35)
    attackType = proto.Field(proto.UINT32, number=36)
...
class JumpListContentnewData(proto.Message):
    ...
    unlockId = proto.Field(proto.UINT32, number=4)
    planOpen = proto.Field(proto.UINT32, number=5)
    planOpenHint = proto.Field(proto.UINT32, number=6)
    planOpenFunction = proto.Field(proto.UINT32, number=7)
    planOpenArgs = proto.Field(proto.UINT32, number=8)
    lastJump = proto.Field(proto.UINT32, number=9)
...
class MonopolyConfigData(proto.Message):
    ...
    battleOrder = proto.Field(proto.UINT32, number=24)
...
class MonopolyDifficultyData(proto.Message):
    ...
    questId = proto.RepeatedField(proto.UINT32, number=10)
    firstRewardItem = proto.MapField(proto.UINT32, proto.UINT32, number=11)
    rewardItem = proto.MapField(proto.UINT32, proto.UINT32, number=12)
    maxRound = proto.Field(proto.UINT32, number=13)
    promptRound = proto.Field(proto.UINT32, number=14)
    token = proto.Field(proto.UINT32, number=15)
    maxOrderNumber = proto.Field(proto.UINT32, number=16)
    initialPoint = proto.Field(proto.UINT32, number=17)
    roundPoint = proto.Field(proto.UINT32, number=18)
    doll = proto.Field(proto.UINT32, number=19)
    mapId = proto.Field(proto.UINT32, number=20)
    rewardRule = proto.Field(proto.UINT32, number=21)
    cost = proto.MapField(proto.UINT32, proto.UINT32, number=22)
    canSweep = proto.Field(proto.BOOL, number=23)
    pptId = proto.Field(proto.UINT32, number=24)
    tokenIcon = proto.Field(proto.STRING, number=25)
    loseId = proto.RepeatedField(proto.UINT32, number=26)
    roundOccupyPoint = proto.Field(proto.UINT32, number=27)
    sweepUnlock = proto.RepeatedField(proto.UINT32, number=28)
    sweepCost = proto.MapField(proto.UINT32, proto.UINT32, number=29)
    sweepReward = proto.MapField(proto.UINT32, proto.UINT32, number=30)
    maxRewardPoint = proto.Field(proto.UINT32, number=31)
    sweepTimes = proto.Field(proto.UINT32, number=32)
...
class MonopolyEffectData(proto.Message):
    ...
    buffType = proto.Field(proto.UINT32, number=5)
    triggerTime = proto.Field(proto.UINT32, number=6)
    triggerParam = proto.RepeatedField(proto.UINT32, number=7)
    buffGet = proto.Field(proto.UINT32, number=8)
    effectType = proto.Field(proto.UINT32, number=9)
    param = proto.Field(proto.UINT32, number=10)
    turn = proto.Field(proto.UINT32, number=11)
    triggerSlg = proto.Field(proto.UINT32, number=12)
    relationBuff = proto.Field(proto.UINT32, number=13)
    triggerdesc = proto.Field(LanguageStringData, number=14)
    triggerEffect = proto.Field(proto.UINT32, number=15)
    obtainDesc = proto.Field(LanguageStringData, number=16)

class MonopolyEffectSlgData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    relationMonoBuff = proto.Field(proto.STRING, number=2)
...
class MonopolyEnemyData(proto.Message):
    ...
    geneId = proto.Field(proto.UINT32, number=12)
    ...
    lockGene = proto.Field(proto.UINT32, number=18)
    spineSize = proto.Field(proto.DOUBLE, number=19)
    spineHudOffset = proto.Field(proto.STRING, number=20)
    spineLeftOffset = proto.Field(proto.STRING, number=21)
    spineRightOffset = proto.Field(proto.STRING, number=22)
    slgBgPic = proto.Field(proto.STRING, number=23)
    spinePosition = proto.RepeatedField(proto.DOUBLE, number=24)

class MonopolyEnemyGroupData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    group = proto.Field(proto.UINT32, number=2)
    rankAdjust = proto.Field(proto.UINT32, number=3)
    enemyId = proto.Field(proto.UINT32, number=4)

class MonopolyGeneData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    targetType = proto.Field(proto.UINT32, number=2)
    geneType = proto.Field(proto.UINT32, number=3)
    param1 = proto.RepeatedField(proto.UINT32, number=4)
    param2 = proto.Field(proto.STRING, number=5)
    param3 = proto.RepeatedField(proto.INT32, number=6)
    targetNumType = proto.Field(proto.UINT32, number=7)
    targetNum = proto.Field(proto.UINT32, number=8)
    damageNum = proto.Field(proto.UINT32, number=9)
    occupyDef = proto.MapField(proto.UINT32, proto.UINT32, number=10)
    extraParam = proto.Field(proto.UINT32, number=11)
    paramPool = proto.MapField(proto.UINT32, proto.UINT32, number=12)
    resourceId = proto.Field(proto.UINT32, number=13)
...
class MonopolyMapFunctionByMapIdData(proto.Message):
...
class MonopolyMapFunctionData(proto.Message):
    ...
    desc = proto.Field(LanguageStringData, number=4)
    rank = proto.Field(proto.UINT32, number=5)
    isShow = proto.Field(proto.UINT32, number=6)
    mapImage = proto.Field(proto.UINT32, number=7)
    type = proto.Field(proto.UINT32, number=8)
    param = proto.Field(proto.UINT32, number=9)
    tergetType = proto.Field(proto.UINT32, number=10)
    triggerTime = proto.Field(proto.UINT32, number=11)
    triggerIcon = proto.Field(proto.STRING, number=12)
    triggerDes = proto.Field(LanguageStringData, number=13)
    remove = proto.Field(proto.BOOL, number=14)
    sortId = proto.Field(proto.UINT32, number=15)
    mapRemove = proto.Field(proto.BOOL, number=16)
    param2 = proto.Field(proto.UINT32, number=17)
...
class MonopolyMapPointData(proto.Message):
    ...
    function = proto.Field(proto.UINT32, number=5)
    terrain = proto.Field(proto.UINT32, number=6)
    movementPoint = proto.Field(proto.UINT32, number=7)
    team = proto.Field(proto.INT32, number=8)
    creatType = proto.MapField(proto.UINT32, proto.UINT32, number=9)
    enemyGroup = proto.Field(proto.UINT32, number=10)
    occupyCost = proto.MapField(proto.UINT32, proto.UINT32, number=11)
    enable = proto.Field(proto.UINT32, number=12)
    element = proto.Field(proto.UINT32, number=13)
...
class MonopolyMapTerrainByMapIdData(proto.Message):
    mapId = proto.Field(proto.UINT32, number=1)
    id = proto.RepeatedField(proto.UINT32, number=2)

class MonopolyMapTerrainData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    mapId = proto.Field(proto.UINT32, number=2)
    name = proto.Field(LanguageStringData, number=3)
    desc = proto.Field(LanguageStringData, number=4)
    mapImage = proto.Field(proto.UINT32, number=5)
    rank = proto.Field(proto.UINT32, number=6)
    isShow = proto.Field(proto.UINT32, number=7)
    triggerType = proto.Field(proto.UINT32, number=8)
    triggerTime = proto.Field(proto.UINT32, number=9)
    type = proto.Field(proto.UINT32, number=10)
    param = proto.Field(proto.UINT32, number=11)
    triggerIcon = proto.Field(proto.STRING, number=12)
    triggerDes = proto.Field(LanguageStringData, number=13)
    remove = proto.Field(proto.BOOL, number=14)
    sortId = proto.Field(proto.UINT32, number=15)
...
class MonopolyOrderByIsshowData(proto.Message):
    isshow = proto.Field(proto.UINT32, number=1)
    id = proto.RepeatedField(proto.UINT32, number=2)
...
class MonopolyOrderData(proto.Message):
    ...
    upClass = proto.MapField(proto.UINT32, proto.UINT32, number=8)
    targetType = proto.Field(proto.STRING, number=9)
    targetParam = proto.RepeatedField(proto.UINT32, number=10)
    range = proto.Field(proto.INT32, number=11)
    orderGene = proto.RepeatedField(proto.UINT32, number=12)
    section = proto.RepeatedField(proto.UINT32, number=13)
    sold = proto.Field(proto.UINT32, number=14)
    isshow = proto.Field(proto.UINT32, number=15)
    orderDesc2 = proto.Field(LanguageStringData, number=16)
    igoreType = proto.Field(proto.UINT32, number=17)
    orderType = proto.Field(proto.INT32, number=18)
    enemyIgone = proto.RepeatedField(proto.UINT32, number=19)
...
class MonopolyPointResourcesData(proto.Message):
    ...
    element = proto.Field(proto.STRING, number=7)
    material = proto.Field(proto.STRING, number=8)
    building = proto.Field(proto.STRING, number=9)
    disappearEffect = proto.Field(proto.STRING, number=10)
    activationEffect = proto.Field(proto.STRING, number=11)

class MonopolyShopData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    token = proto.Field(proto.UINT32, number=2)
    itemNumber = proto.Field(proto.UINT32, number=3)
    refresh = proto.RepeatedField(proto.UINT32, number=4)

class MonopolyShopItemData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    group = proto.Field(proto.UINT32, number=2)
    storeId = proto.Field(proto.UINT32, number=3)
    weight = proto.Field(proto.UINT32, number=4)

class MonopolyStoreItemData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    orderId = proto.Field(proto.UINT32, number=2)
    limitArgs = proto.Field(proto.UINT32, number=3)
    price = proto.Field(proto.UINT32, number=4)

class MonopolyTaskData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    monopolyConfig = proto.Field(proto.UINT32, number=2)
    name = proto.Field(proto.STRING, number=3)
    des = proto.Field(proto.STRING, number=4)
    sequence = proto.Field(proto.UINT32, number=5)
    actionParam = proto.Field(proto.BOOL, number=6)
    unlock = proto.Field(proto.UINT32, number=7)
    conditionClass = proto.Field(proto.UINT32, number=8)
    conditionNum = proto.Field(proto.UINT32, number=9)
    rewardList = proto.RepeatedField(proto.STRING, number=10)
...
class MonopolyWinConditionData(proto.Message):
    ...
    controlType = proto.Field(proto.UINT32, number=10)
    loseHint = proto.Field(proto.UINT32, number=11)
...
class SimCombatMythicGroupData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    goupName = proto.Field(LanguageStringData, number=2)
    groupBg = proto.Field(proto.STRING, number=3)
    groupDesc = proto.Field(LanguageStringData, number=4)
    config = proto.RepeatedField(proto.UINT32, number=5)
    level = proto.Field(proto.UINT32, number=6)
...
class SimCombatResourceData(proto.Message):
    ...
    weaponPartRaidLimit = proto.Field(proto.UINT32, number=11)
...
class StageEnemyData(proto.Message):
    ...
    guardradius = proto.Field(proto.INT32, number=11)
...
class SystemTutorialGroupData(proto.Message):
    ...
    finishGroup = proto.RepeatedField(proto.UINT32, number=10)
    skipFinishGroup = proto.RepeatedField(proto.UINT32, number=11)
...
class UnlockData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    condition = proto.RepeatedField(proto.UINT32, number=2)
    lockType = proto.Field(proto.UINT32, number=3)
    prompt = proto.Field(LanguageStringData, number=4)
    interfaceId = proto.Field(proto.UINT32, number=5)
    icon = proto.Field(proto.STRING, number=6)
    homeButtonRedhint = proto.Field(proto.UINT32, number=7)
    unlockName = proto.Field(LanguageStringData, number=8)
    cmdList = proto.RepeatedField(proto.UINT32, number=9)
    isClose = proto.Field(proto.BOOL, number=10)
    openDetail = proto.Field(proto.INT64, number=11)
    sequence = proto.Field(proto.UINT32, number=12)
...
class WeeklyBStoryData(proto.Message):
    ...
    injuryCoefficient = proto.Field(proto.DOUBLE, number=4)
    bMainId = proto.Field(proto.UINT32, number=5)
...
class WeeklyCycleData(proto.Message):
    ...
    bCost = proto.MapField(proto.UINT32, proto.UINT32, number=4)
    bName = proto.Field(LanguageStringData, number=5)
    bBossIntegral = proto.Field(proto.UINT32, number=6)

class WeeklyDegreeData(proto.Message):
    id = proto.Field(proto.UINT32, number=1)
    cycleId = proto.Field(proto.UINT32, number=2)
    level = proto.Field(proto.UINT32, number=3)
    showEnemyList = proto.Field(proto.STRING, number=4)
    showEnemyDescList = proto.RepeatedField(proto.UINT32, number=5)
    maxTeam = proto.Field(proto.UINT32, number=6)
    bId = proto.RepeatedField(proto.UINT32, number=7)
    bPptId = proto.Field(proto.UINT32, number=8)
    questChallengeType = proto.Field(proto.UINT32, number=9)
    name = proto.Field(LanguageStringData, number=10)
    des = proto.Field(LanguageStringData, number=11)
    bBossId = proto.Field(proto.STRING, number=12)
    bBossEnName = proto.Field(LanguageStringData, number=13)
    bBossPic = proto.Field(proto.STRING, number=14)
    bBossLogo = proto.Field(proto.STRING, number=15)
