...
class GlobalSystemData(proto.Message):
    ...
    repeatedlyWeaponSkin = proto.MapField(proto.UINT32, proto.UINT32, number=306)
    repeatedlyModSkin = proto.MapField(proto.UINT32, proto.UINT32, number=307)
...
class GunData(proto.Message):
    ...
    clothesEffectId = proto.RepeatedField(proto.UINT32, number=45)
    clothesAudioId = proto.Field(proto.UINT32, number=46)
    shieldType = proto.Field(proto.UINT32, number=47)
    maxGrade = proto.Field(proto.UINT32, number=48)
    shieldEffectId = proto.Field(proto.UINT32, number=49)
    baseSupply = proto.Field(proto.UINT32, number=50)
    supplyTypeBanList = proto.RepeatedField(proto.UINT32, number=51)
    extraSkill = proto.Field(proto.UINT32, number=52)
    shieldBrokenEffectId = proto.Field(proto.UINT32, number=53)
    attackType = proto.Field(proto.UINT32, number=54)
    gachaGetTimeline = proto.Field(proto.STRING, number=55)
    beSuppressedConfig = proto.RepeatedField(proto.INT32, number=56)
    shape = proto.Field(proto.UINT32, number=57)
    shapeParam = proto.Field(proto.STRING, number=58)
    shapeIcon = proto.Field(proto.STRING, number=59)
    shapeTerrain = proto.Field(proto.UINT32, number=60)
    idleType = proto.Field(proto.UINT32, number=61)
    displacement = proto.Field(proto.UINT32, number=62)
    isHide = proto.Field(proto.BOOL, number=63)
    weakTag = proto.Field(proto.STRING, number=64)
    suppressGroup = proto.RepeatedField(proto.INT32, number=65)
    unlockHint = proto.Field(proto.UINT32, number=66)
    unlockDorm = proto.RepeatedField(proto.UINT32, number=67)
    guardRadius = proto.Field(proto.INT32, number=68)
    guardRadiusShow = proto.Field(proto.INT32, number=69)
    gachaGetAudio = proto.Field(proto.UINT32, number=70)
    gachaGetVoice = proto.Field(proto.UINT32, number=71)
    weakWeaponTag = proto.Field(proto.INT32, number=72)
    feature = proto.Field(proto.UINT32, number=73)
...
class GunPresetData(proto.Message):
    ...
    weaponModSuitList = proto.Field(proto.STRING, number=22)
    weaponModLevelList = proto.RepeatedField(proto.UINT32, number=23)
    weaponModAffixList = proto.Field(proto.STRING, number=24)
    talentGroupPos = proto.Field(proto.UINT32, number=25)
    talentNodeLevelList = proto.Field(proto.STRING, number=26)
    name = proto.Field(LanguageStringData, number=27)
    walk = proto.Field(proto.UINT32, number=28)
    climb = proto.Field(proto.UINT32, number=29)
    fly = proto.Field(proto.UINT32, number=30)
    shin = proto.Field(proto.UINT32, number=31)
    moveCode = proto.Field(proto.UINT32, number=32)
    propertyId = proto.Field(proto.UINT32, number=33)
    aiList = proto.RepeatedField(proto.INT32, number=34)
    shieldForDeploy = proto.Field(proto.UINT32, number=35)
    tag = proto.Field(proto.STRING, number=36)
    attackType = proto.Field(proto.UINT32, number=37)
    element = proto.Field(proto.UINT32, number=38)
    shieldType = proto.Field(proto.UINT32, number=39)
    shieldEffectId = proto.Field(proto.UINT32, number=40)
    shieldBrokenEffectId = proto.Field(proto.UINT32, number=41)
    isClassTalentFullUpgraded = proto.Field(proto.BOOL, number=42)
    presetType = proto.Field(proto.UINT32, number=43)
    beSuppressedConfig = proto.RepeatedField(proto.INT32, number=44)
    idleType = proto.Field(proto.UINT32, number=45)
    skillGradeGroup = proto.RepeatedField(proto.UINT32, number=46)
    skillExtraGroup = proto.RepeatedField(proto.UINT32, number=47)
    weakTag = proto.Field(proto.STRING, number=48)
    guardRadius = proto.Field(proto.INT32, number=49)
    guardRadiusShow = proto.Field(proto.INT32, number=50)
    skillFaction = proto.Field(proto.UINT32, number=51)
    skillFaction2 = proto.Field(proto.UINT32, number=52)
    enablePrivateSkill = proto.Field(proto.UINT32, number=53)
    weaponModAlienationList = proto.RepeatedField(proto.UINT32, number=54)
    talentSkillList = proto.RepeatedField(proto.UINT32, number=55)
    jump = proto.Field(proto.UINT32, number=56)
    weakWeaponTag = proto.Field(proto.INT32, number=57)
    combatPowerReplace = proto.Field(proto.INT32, number=58)
    feature = proto.Field(proto.UINT32, number=59)
    btPath = proto.Field(proto.STRING, number=60)
...
class UpActivityData(proto.Message):
    ...
    useOrder = proto.Field(proto.UINT32, number=8)
...
class WeaponModSkinPlanData(proto.Message):
    typeId = proto.Field(proto.UINT32, number=1)
    skinNum = proto.RepeatedField(proto.UINT32, number=2)
    modMount1 = proto.RepeatedField(proto.UINT32, number=3)
    modMount2 = proto.RepeatedField(proto.UINT32, number=4)
    modMount3 = proto.RepeatedField(proto.UINT32, number=5)
    modMount4 = proto.RepeatedField(proto.UINT32, number=6)
    modMount5 = proto.RepeatedField(proto.UINT32, number=7)
    modMount6 = proto.RepeatedField(proto.UINT32, number=8)
...
class WeeklyDegreeData(proto.Message):
    ...
    bBossName = proto.Field(LanguageStringData, number=16)
